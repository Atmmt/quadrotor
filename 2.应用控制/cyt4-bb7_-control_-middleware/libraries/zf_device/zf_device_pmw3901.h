...
//====================================================硬件 SPI 驱动====================================================
#define PMW3901_SPI_SPEED            (2 * 1000 * 850 )                         // 硬件 SPI 速率
#define PMW3901_SPI                  (SPI_3           )                         // 硬件 SPI 号
#define PMW3901_SCLK_PIN             (SPI3_CLK_P03_2  )                         // 硬件 SPI SCK 引脚
#define PMW3901_MOSI_PIN             (SPI3_MOSI_P03_1 )                         // 硬件 SPI MOSI 引脚
#define PMW3901_MISO_PIN             (SPI3_MISO_P03_0 )                         // 硬件 SPI MISO 引脚
#define PMW3901_CS_PIN               (P03_3)                                    // CS 片选引脚
