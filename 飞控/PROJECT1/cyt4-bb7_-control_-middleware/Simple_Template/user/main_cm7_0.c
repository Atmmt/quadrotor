...
QueueHandle_t g_xQueueBlueTooth_Ori;  //蓝牙串口
QueueHandle_t g_xQueueBlueTooth_Pro;  //蓝牙串口数据包
...
//      rs485_uart4->init(115200);
      ...
      user_uart1->init(115200);

 
//     pSerialInterface_t user_uart2 = &UserDev_usart2;
//     user_uart2->init(9600);
